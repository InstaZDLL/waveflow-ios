...
struct DurationFormatTests {
    ...
    @Test func formatsAsMinutesAndSeconds() {
    ...
    @Test func handlesInvalidDurations() {
    ...
    @Test func staysInWesternArabicNumerals() {
        #expect(formatDuration(3675).allSatisfy { $0.isASCII })
    }

    @Test func formatsTotalDurationInMinutes() {
    ...
    @Test func formatsTotalDurationInHours() {
